		...
		<article className="bg-[#11182780] border border-[#10B981] p-4 md:p-6 grid gap-y-5 rounded-2xl md:mx-auto md:w-[578px]">
			...
			<figure className="bg-[#1F293780] p-4 rounded-xl grid gap-y-3">
				...
				<figcaption>
					...
					<p className="font-bold">Celestial Harmony #004</p>
				</figcaption>
				<figcaption>
					<p className="text-[#E5E7EB]">Description</p>
					<p className="font-bold">A mesmerizing blend of cosmic elements and digital artistry</p>
				</figcaption>
				<figcaption>
			...
			<div className="p-4 grid grid-cols-2 gap-x-2 md:gap-x-4">
				<button
					className="bg-[#1F2937] hover:opacity-80 rounded-lg flex text-[#E5E7EB] p-2 items-center justify-center gap-x-2 transition transform active:scale-90">
					<Image
						src={share}
						alt="share icon"
						width={16}
				...
				<button
					className="bg-gradient-to-r from-[#EC4899] to-[#8B5CF6] hover:opacity-80 rounded-lg flex text-[#E5E7EB] p-2 items-center justify-center gap-x-2 transition transform active:scale-90">
					<Image
						src={cube}
						alt="cube icon"
						width={16}
